...
const NavigationShowModal = ({ phrase, onClose }: PhraseModalProps) => {
  return (
    <MotionCenter
      position="fixed"
      top={0}
        ...
        <VStack spacing={6}>
          ...
          >
            <HStack mb={2} color="orange.200">
              <FaMapMarkedAlt size="14px" />
              <Text fontSize="xs" fontWeight="bold" textTransform="uppercase">
                Street Tips & Directions
              </Text>
            </HStack>
...
export default NavigationShowModal;
